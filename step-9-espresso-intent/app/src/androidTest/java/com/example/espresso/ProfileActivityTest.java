...
public class ProfileActivityTest {
    ...
    public void testSignUpFlow() throws Exception {
        ...
        onView(withId(R.id.edit_email)).perform(typeText("luke@starwars.com"));
        onView(withId(R.id.edit_fullname)).perform(typeText("Luke Skywalker"));
        onView(withId(R.id.button_register)).perform(click());
        onView(withId(R.id.text_user_info)).check(matches(withText("Hello Luke Skywalker")));
    }
